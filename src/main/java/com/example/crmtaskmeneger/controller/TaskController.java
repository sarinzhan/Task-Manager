...
public class TaskController {
    ...
    public ModelAndView getAllTasks(ModelAndView model, @ModelAttribute(name = "user")UserDto userDto,
        ...
        List<TaskDtoResponse> tasksList ;
        List<Task> allAvailTask = taskService.getAllAvailTask();
        System.out.println("Количество задач после БД: " + allAvailTask.size());
        tasksList = TaskMapping.mapModelEntityToDtoResponseWithAuthorAndExecutorList(allAvailTask);
        System.out.println("Еоличество задач после мапинга " + tasksList.size());
